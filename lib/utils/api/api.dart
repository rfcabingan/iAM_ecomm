...
import 'services/fulfillment_api.dart';
import 'services/help_center_api.dart';
...
class ApiMiddleware {
  ...
  static final FulfillmentApi fulfillment = FulfillmentApi(_client);
  static final HelpCenterApi helpCenter = HelpCenterApi(_client);
